...
# vobject-rs vendored copy: the upstream repository's documentation tree is
# vendored inside the package (see VENDORED-NOTICE.txt), so the doctests
# keep running against it.
REPOSITORY = HERE.parent / "upstream_docs"
